const DashboardPage = () => {
  return (
    <div className="flexitems-center justify-center min-h-screen bg-red-100">

      <h1 className="items-center justify-center flex flex-col items-center justify-center gap-16 text-center  pt-6 text-4xl font-black">
